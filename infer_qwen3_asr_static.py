...
def get_args():
    ...
    p.add_argument("--wav", type=str, required=True, help=".wav or .npy path")
...
def _infer_one(
    ...
    cur_len = 0
    logits = _run_decoder(input_ids, cur_len, prompt_attn, num_new_tokens=S0)
    cur_len += S0
